------------------------------------------------------------------------------------------
28-Jan-2026 05:26                 B01002_OP10_INSPECTION                           Page  1
------------------------------------------------------------------------------------------
...
Length-Xavg             0.3783    0.3850   -0.0050   +0.0050   -0.0067 <--+---     -0.0017
------------------------------------------------------------------------------------------
...
Length-Zavg             0.3087    0.3090   -0.0050   +0.0000   -0.0003 ---+--*
------------------------------------------------------------------------------------------
...
Z-axis                 -2.5489   -2.5510                        0.0021
TruePosition2D          0.0154                        0.0080              +-->      0.0074
...
X-axis                  0.4275    0.4400                       -0.0125
Y-axis                 -0.0849   -0.0842                       -0.0007
TruePosition2D          0.0251                        0.0168              +-->      0.0083
Diameter                0.1358    0.1360   -0.0050   +0.0050   -0.0002 ---*---
------------------------------------------------------------------------------------------
INSPECTION ITEM #06 OVERALL BOLT LENGTH
 
Plane:DATUM_C_PLANE--Point:BOLT_BACK_POINT
Length-Zavg             3.4042    3.4060   -0.0050   +0.0050   -0.0018 --*+---
------------------------------------------------------------------------------------------
INSPECTION ITEM #07 CHARGING SLOT DEPTH
 
Plane:DATUM_A_PLANE--Point:CHARGING_SLOT_DEPTH_POINT
Length-Xavg             0.2440    0.2500   -0.0050   +0.0050   -0.0060 <--+---     -0.0010
------------------------------------------------------------------------------------------
INSPECTION ITEM #08 FIRING PIN SLOT DEPTH
 
Plane:DATUM_A_PLANE--Point:FIRING_PIN_SLOT_DEPTH
Length-Xavg             0.3082    0.3140   -0.0020   +0.0020   -0.0058 <--+---     -0.0038
------------------------------------------------------------------------------------------
ADJUST T11D BY 0.0033
 
ADJUST T7D BY -0.0028
 
T9D IS BAD:PLEASE REPLACE T9 WITH A NEW TOOL
 
ADJUST MACRO #503 BY 0.0073
ADJUST MACRO #504 BY -0.0021
==========================================================================================
------------------------------------------------------------------------------------------
28-Jan-2026 05:26                 B01002_OP10_INSPECTION                           Page  2
------------------------------------------------------------------------------------------
(in)                    ACTUAL   NOMINAL    LO-TOL    HI-TOL DEVIATION GRAPHIC       ERROR
------------------------------------------------------------------------------------------
ADJUST MACRO #501 BY 0.0125
ADJUST MACRO #502 BY -0.0008
ADJUST T1D BY -0.0030
 
Duration 1 mins 38 secs              FAIL in:4 out:6                         End of Report
==========================================================================================

